...
int main() {
	...
	for (;;) {
		//could use frame independent looping
		...
		case 'a':
		case 'A':
			myController.changeCosmoDirection(NO_DIR_AGGRESSIVE);
			break;
		case 'n':
		case 'N':
			myController.changeCosmoDirection(NO_DIR_PASSIVE);
			break;
		case 'i':
		case 'I':
		...
		case 's':
		case 'S':
			myController.makeCosmoSuper(true);
			break;
		case 't':
		case 'T':
			myController.makeBalloonsTerrible(true);
			break;
		case 'b':
		case 'B':
