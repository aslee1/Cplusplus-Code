...
enum DIRECTION{NO_DIR=0,LEFT,RIGHT,UP,DOWN, NO_DIR_PASSIVE,NO_DIR_AGGRESSIVE};
enum SPEED{NO_SPD=0,SLOW, MEDIUM, FAST };
enum COLLISION{NO=0, COSMO_POPPED,BALLOON_CLOBBERED, ANVIL_HIT};
...
//balloon bounding boxes (width , height)
